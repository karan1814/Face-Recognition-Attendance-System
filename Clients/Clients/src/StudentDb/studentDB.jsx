...
const StudentDashboard = () => {
  ...
  const logoutbutton = async () => {
    try {
      await axios.get('http://localhost:5000/auth/logout'); // calling backend logout
    ...
    <div className="d-flex">
      ...
      >
        ...
        <ul className="nav flex-column">
          ...
          <li className="nav-item mb-2">
            <Link className="nav-link text-white" to="/student/Viewattendance">Attendance History</Link>
          </li>
          <li className="nav-item mb-2">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div className="dropdown">
              ...
              <ul className="dropdown-menu dropdown-menu-end shadow" aria-labelledby="profileDropdown">
                ...
                <li><Link className="dropdown-item text-danger" onClick={logoutbutton}><FaSignOutAlt className="me-2" /> Logout</Link></li>
              </ul>
            </div>
          </div>
        </div>
